...
Communicate insights clearly through storytelling and visual design
...
Self-sourced dataset related to the e-commerce industry
...
Connected Power BI directly to an Azure SQL database
...
Created calculated columns and measures (e.g., Sales, Total Sales)
...
YTD and YoY performance tables
...
Final written analysis report (PDF/PowerPoint)

Group presentation demonstrating insights and recommendations

Individual project reflection focusing on collaboration and learning outcomes
...
Reflected on personal development and teamwork
